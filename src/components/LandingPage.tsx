...
const LandingPage = () => {
  return (
    ...
    <p className='introduction'>This Web Application allows users to create a create a resume from scratch and only input there job(s) descriptions and use chat GPT's api to improve the resume and return a filled out template in a .docx file. You'll be able to choose from a set of resume templates.</p>
